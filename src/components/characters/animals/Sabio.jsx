...
export default function Sabio(props) {
  return (
    <ChibiAvatar
      id="sabio" bg={['#a78bfa', 'var(--violet)']} eyeY={56}
      body={<g>
        {/* penachos (orejas de pluma) */}
        <path d="M34 12 L26 -6 L48 8 Z" fill="var(--violet)" />
        <path d="M86 12 L94 -6 L72 8 Z" fill="var(--violet)" />
        ...
        {/* pico */}
        <path d="M55 64 L65 64 L60 73 Z" fill="var(--gold-deep)" />
        {/* plumitas del pecho */}
